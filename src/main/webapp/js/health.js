...
/*
 * h_black.style.width=h_ow+"px"; h_black.style.height=h_oh+"px";
 */
...
/*
 * var h_yes=document.getElementById('h_yes'); var
 * h_no=document.getElementById('h_no'); h_yes.onclick=function (){
 * h_black.style.display="none"; h_popup.style.display="none"; }
 * h_no.onclick=function () { h_black.style.display="none";
