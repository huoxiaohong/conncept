...
/*---------------排序方式------------------------*/
var hpx = document.getElementById('c_paixu'), hpd = document
		.getElementById('c_pdown'), hpp = document.getElementById('c_pp'),
/* hpp=document.getElementsByClassName('c_pp')[0]; */

plis = hpp.getElementsByTagName('li');
// alert(plis.length);
// alert(hpp);
var hsot = document.getElementById('c_sort'), opts = hsot
